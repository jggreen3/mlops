...
# Load data
train_data = pd.read_csv("labs/data/adult.data", names=col_names)
test_data = pd.read_csv("labs/data/adult.test", names=col_names)
...
train_new.to_csv("labs/data/processed_train_data.csv")
test_new.to_csv("labs/data/processed_test_data.csv")

# Save pipeline
with open("labs/data/pipeline.pkl", "wb") as f:
    pickle.dump(clf, f)
